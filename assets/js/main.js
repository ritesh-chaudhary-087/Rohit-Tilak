...
$(document).ready(function () {
  ...
  $(".po-task-3").slick({
    ...
    slidesToScroll: 1,
    prevArrow:
      '<span class="priv_arrow3"><i class="fa-regular fa-arrow-right"></i></span>',
    nextArrow:
      '<span class="next_arrow3"><i class="fa-regular fa-arrow-left"></i></span>',
    responsive: [
      {
        breakpoint: 1024,
        settings: {
  ...
  $(".po-brands").slick({
    ...
    slidesToScroll: 1,
    prevArrow:
      '<span class="priv_arrow4"><i class="fa-regular fa-arrow-right"></i></span>',
    nextArrow:
      '<span class="next_arrow4"><i class="fa-regular fa-arrow-left"></i></span>',
    responsive: [
      {
        breakpoint: 1024,
        settings: {
  ...
  $(document).ready(function () {
    // First Slider
    $("#slider-1 .row").slick({
      slidesToShow: 4, // Show 2 images at a time
      slidesToScroll: 1, // Scroll 1 image at a time
      infinite: true, // Infinite loop
      // Show arrows for navigation
      autoplay: true, // Enable auto sliding
      autoplaySpeed: 1000, // Slide every 2 seconds (2000ms)
      responsive: [
        {
          breakpoint: 768, // On smaller screens (mobile)
          settings: {
